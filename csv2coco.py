...
class Csv2CoCo:
    ...
    def to_coco(self, keys):
        ...
        for key in keys:
            ...
            for shape in shapes:
                bboxi = [int(cor) for cor in shape[:-1]]
                label = shape[-1]
...
if __name__ == '__main__':
    ...
    for file in train_keys:
        shutil.copy(image_dir+file, f"{saved_coco_path}coco/images/train2017/")
    for file in val_keys:
        shutil.copy(image_dir+file, f"{saved_coco_path}coco/images/val2017/")
    # 把验证集转化为COCO的json格式
